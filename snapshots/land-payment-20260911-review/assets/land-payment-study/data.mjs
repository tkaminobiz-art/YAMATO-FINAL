...
import {properties as sourceProperties} from './suumo-properties.mjs';
// Preserve source records; withhold contradictory facilities from every runtime consumer.
export const properties=sourceProperties.map(p=>p.id==='s20080819'?Object.freeze({
 ...p,amenities:[],amenitiesReview:{status:'pending',sourceCount:p.amenities.filter(a=>a.name).length,checkedAt:'2026-09-11'}
}):p);
